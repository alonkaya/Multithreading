...
public abstract class MicroService implements Runnable {
    ...
    //a hashmap for the event types and corresponding callbacks
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
        //subscribing to the messagebus and adding the event type and callback to the hashmap
    ...
    protected final <B extends Broadcast> void subscribeBroadcast(Class<B> type, Callback<B> callback) {
        //subscribing to the messagebus and adding the broadcast and callback to the hashmap
    ...
    protected final <T> Future<T> sendEvent(Event<T> e) {
        //receving the future even from the message bus for waiting on it
    ...
    protected final void sendBroadcast(Broadcast b) {
        //sending the messagebus a broadcast
    ...
    protected final <T> void complete(Event<T> e, T result) {
        //sending the result to the event
    ...
    public final void run() {
        //registering to the messagebus
        messageBus.register(this);
        this.subscribeBroadcast(TerminationBroadcast.class, (message)-> terminate());
        initialize();
        while (!terminated) {
            try {
                //awaiting message and invoking the callbacks required for it
        ...
        //unregistering when a termination call was executed
